...
<div class="card">
  ...
  <div class="card-body">
    ...
    <user-addresses-create-and-edit inline-template>
      <form class="form-horizontal" role="form" action="{{ route('user_addresses.index') }}" method="POST">
        <!-- 引入 csrf token 字段 -->
      {{ csrf_field() }}
      <!-- 注意这里多了 @change -->
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="contact_iphone" value="{{ old('contact_iphone', $address->contact_iphone) }}">
          </div>
        </div>
